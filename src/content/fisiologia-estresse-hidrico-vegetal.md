...
O **ácido abscísico (ABA)** atua como o principal mediador químico do estresse hídrico. Sintetizado nas raízes e transportado via xilema, ou produzido *in situ* nas células-guarda, o ABA induz o efluxo de íons potássio (K^+) e ânions como o cloreto (Cl^-) para o apoplasto.
...
Para evitar a plasmólise em condições de baixo \psi_{solo}, as plantas acumulam solutos organicamente compatíveis (osmolitos), como:
